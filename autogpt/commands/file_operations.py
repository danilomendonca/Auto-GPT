...
@command("create_file", "Create File", '"filename": "<filename>"')
def create_file(filename: str) -> str:
    ...
    Returns:
        str: A message indicating success or failure
    """
    if is_duplicate_operation("create", filename):
...
@command("replace_in_file", "Replace in file", '"filename": "<filename>"', '"text": "<text>"', '"replacement": "<replacement>"')
...
@command("file_exists", "Check if file exists", '"filename": "<filename>"')
def file_exists(filename: str) -> str:
    ...
    """
    try:
        return os.path.exists(filename) and os.path.isfile(filename) and "File exists." or "File does not exist."
    except Exception as e:
